...
public class SolrResultPageToSearchPageConverter
		extends
			PopulatingConverter<SolrResultPage<ProductDocument>, SearchPageData<ProductDocument>> {

	@Override
	public SearchPageData<ProductDocument> convert(
			SolrResultPage<ProductDocument> source) {
		SearchPageData<ProductDocument> target = new SearchPageData<ProductDocument>();
